...
GLYPHS = {
    ...
    "C": (2, [[(2,3),(0,3),(0,0),(2,0)]]),
    "D": (2, [[(0,0),(0,3),(1,3),(2,2),(2,1),(1,0),(0,0)]]),
    ...
    "K": (2, [[(0,0),(0,1.5),(0,3)], [(0,1.5),(2,3)], [(0,1.5),(2,0)]]),
    "L": (2, [[(0,3),(0,0),(2,0)]]),
    "M": (2, [[(0,0),(0,3),(1,3),(1,1.5)], [(1,3),(2,3),(2,0)]]),
    "N": (2, [[(0,0),(0,3),(2,0),(2,3)]]),
    "O": (2, [[(0,0),(0,3),(2,3),(2,0),(0,0)]]),
    "P": (2, [[(0,0),(0,1.5),(0,3)], [(0,3),(2,3),(2,1.5),(0,1.5)]]),
    "Q": (2, [[(0,0),(0,3),(2,3),(2,0),(0,0)], [(1,1.5),(2,0)]]),
    "R": (2, [[(0,0),(0,1.5),(0,3)], [(0,3),(2,3),(2,1.5),(1,1.5),(0,1.5)], [(1,1.5),(2,0)]]),
    ...
    " ": (1, []),
    "!": (1, [[(0.5,3),(0.5,1)], [(0.5,0.5),(0.5,0)]]),
    "?": (2, [[(0,3),(2,3),(2,1.5),(1,1.5),(1,1)], [(1,0.5),(1,0)]]),
    "-": (2, [[(0,1.5),(2,1.5)]]),
    ".": (1, [[(0.5,0.6),(0.5,0)]]),
    "'": (1, [[(0.5,3),(0.5,2.4)]]),
    "+": (2, [[(0,1.5),(1,1.5),(2,1.5)], [(1,0.5),(1,1.5),(1,2.5)]]),
}
# fmt: on
